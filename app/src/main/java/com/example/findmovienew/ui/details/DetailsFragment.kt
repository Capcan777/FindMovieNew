package com.example.findmovienew.ui.details
...
import com.example.findmovienew.databinding.FragmentDetailsBinding
...
//                arguments = bundleOf(ARGS_MOVIE_ID to movieId, ARGS_POSTER_URL to posterUrl)
//            }
//        }
        fun createArgs(movieId: String, posterUrl: String): Bundle = bundleOf(ARGS_MOVIE_ID to movieId, ARGS_POSTER_URL to posterUrl)
    }
