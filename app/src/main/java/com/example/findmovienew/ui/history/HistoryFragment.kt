package com.example.findmovienew.ui.history
...
import com.example.findmovienew.databinding.FragmentHistoryBinding
import com.example.findmovienew.domain.models.Movie
import com.example.findmovienew.presentation.history.HistoryState
...
class HistoryFragment : Fragment() {
    ...
    private fun render(state: HistoryState) {
        when(state) {
            ...
            is HistoryState.Loaging -> showLoading()
        }
    }
